...
public class LoginX extends JavaPlugin implements Listener {
    ...
    public void onInvClick(InventoryClickEvent e) {
        ...
        if (title.contains("Günlük Ödül")) {
            if (m == Material.BARRIER) { p.closeInventory(); return; }
            Integer clickedDay = clicked.getItemMeta().getPersistentDataContainer().get(dailyRewardDayTag, PersistentDataType.INTEGER);
            if (clickedDay == null) return; // cam / bilgi itemi — hiçbir işlem yapma

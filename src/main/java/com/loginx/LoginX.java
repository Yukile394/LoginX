...
public class LoginX extends JavaPlugin implements Listener {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        switch (cmdName) {
            ...
            case "arenawand" -> {
                ...
                p.getInventory().addItem(wand);
                p.sendMessage(color("&fSilvera &#ff9ecb✦ &fArena Wand envanterine verildi."));
    ...
    private ItemStack createArenaWand() {
        ...
        im.setDisplayName(color("&fSilvera &#ff9ecb&l✦ Arena Wand"));
    ...
    public void onArenaWandUse(PlayerInteractEvent e) {
        ...
        if (act == Action.RIGHT_CLICK_BLOCK) {
            ...
            p.sendMessage(color("&fSilvera &#ff9ecb✦ &f1. nokta seçildi: &#ff9ecb"
                + clicked.getBlockX() + ", " + clicked.getBlockY() + ", " + clicked.getBlockZ()));
            p.playSound(p.getLocation(), Sound.BLOCK_NOTE_BLOCK_PLING, 1f, 1.5f);
        } else {
            Location pos1 = elyWandPos1.get(p.getUniqueId());
            if (pos1 == null || pos1.getWorld() == null || !pos1.getWorld().equals(clicked.getWorld())) {
                p.sendMessage(color("&#ff4444&l[ARENA] &fÖnce sağ tıkla ile 1. noktayı seç!"));
                return;
            }
            ...
            p.sendMessage(color("&fSilvera &#ff9ecb✦ &fBölge oluşturuldu! &7(" + elytraZones.size() + ". bölge)"));
            p.sendMessage(color("  &7Alan: &f"
                ...
                + " &7— bu alanda elytra kullanılamaz."));
    ...
    private ItemStack lootChestFillerItem() {
        ...
        List<String> lore = new ArrayList<>();
        lore.add(color("&#4a4a5a▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        lore.add(color("&fSilvera &#ff9ecbDüel Sandığı"));
        lore.add(color("&#4a4a5a▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        im.setLore(lore);
    ...
    public void onGlide(EntityToggleGlideEvent e) {
        ...
        if (isInAnyElytraZone(p.getLocation())) {
            e.setCancelled(true);
            p.sendMessage(color("&fSilvera &#ff9ecb✦ &fArena Bölgesinde Elytra Kullanamazsın!"));
            p.sendActionBar(color("&#ff9ecb✖ &fBu bölgede elytra süzülemez!"));
    ...
    /** Oyuncu elytra yasaklı bir bölgedeyken süzülmeye devam etmesini engeller (sürekli kontrol). */
    private void startElytraZoneWatcher() {
        new BukkitRunnable() {
            @Override public void run() {

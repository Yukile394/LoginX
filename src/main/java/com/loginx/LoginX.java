...
public class LoginX extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        // ─── Sonsuz Gece Görüşü — her 3 saniyede yenile (lag yok, chat yok) ───
        new BukkitRunnable() {
            @Override public void run() {
                for (Player p : Bukkit.getOnlinePlayers()) {
                    p.addPotionEffect(new org.bukkit.potion.PotionEffect(
                        org.bukkit.potion.PotionEffectType.NIGHT_VISION,
                        100,   // 5 sn süre — 3 sn'de yenilediğimiz için hiç bitmez
                        0,     // seviye 1
                        false, // ambient: false → partiküller görünmez
                        false, // particles: false → partiküller kapalı
                        false  // icon: false → HUD ikonu gösterme
                    ), false); // overwrite=false → sürekli uzatır
                }
            }
    ...
    public void onPlayerRespawn(PlayerRespawnEvent e) {
        ...
        new BukkitRunnable() {
            @Override public void run() {
                p.addPotionEffect(new org.bukkit.potion.PotionEffect(
                    org.bukkit.potion.PotionEffectType.NIGHT_VISION, 200, 0, false, false, false));
            }

...
public class LoginX extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        // ─── Sonsuz Gece Görüşü — her 90 saniyede yenile (2 dk sabit, lag yok, chat yok) ───
        new BukkitRunnable() {
            @Override public void run() {
                for (Player p : Bukkit.getOnlinePlayers()) {
                    p.addPotionEffect(new org.bukkit.potion.PotionEffect(
                        org.bukkit.potion.PotionEffectType.NIGHT_VISION,
                        2400,  // 2 dakika (120 sn × 20 tick)
                        0,     // seviye 1
                        false, // ambient: false
                        false, // particles: false
                        false  // icon: false — HUD ikonu yok
                    ), true);
                }
            }
        }.runTaskTimer(this, 0L, 1800L); // her 90 saniyede bir yenile
    ...
    public void onPlayerRespawn(PlayerRespawnEvent e) {
        ...
        new BukkitRunnable() {
            @Override public void run() {
                p.addPotionEffect(new org.bukkit.potion.PotionEffect(
                    org.bukkit.potion.PotionEffectType.NIGHT_VISION, 2400, 0, false, false, false), true);
            }

...
public class LoginX extends JavaPlugin implements Listener {
    ...
    private void applyAttackSpeedForHeldItem(Player p) {
        ...
        // Önce LoginX modifier'ını temizle
        UUID modUuid = new UUID(0x4C6F67696E58L, 0x41747461636BL); // "LoginXAttack"
        ...
        // Vanilla base attack speed ~4.0 /s
        // Modifier: ADD_SCALAR ile çarp: speed=2.0 → 2x hız
        // Hedef speed = 4.0 * speed, dolayısıyla scalar = speed - 1
    ...
    private void spawnNPCEntity(SilveraNPC npc) {
        ...
        try {
            citizensNPC.data().setPersistent(NPC.Metadata.LOOK_CLOSE, false);
        } catch (Exception ignored) {}

...
public class LoginX extends JavaPlugin implements Listener {
    ...
    /** Silvera markalı sohbet öneki: "Silvera" pembe, işaret grisi, devamı beyaz — kalın değil. */
    private String silveraPrefix() {
        return color("&#ff9ecbSilvera &#8a8a8a✦ &f");
    }
    ...
    private ItemStack createArenaWand() {
        ...
        im.setDisplayName(color("&#ff9ecbSilvera &#8a8a8a✦ &fArena Wand"));
    ...
    private ItemStack lootChestFillerItem() {
        ...
        List<String> lore = new ArrayList<>();
        lore.add(color("&#4a4a5a▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        lore.add(color("&#ff9ecbSilvera &#8a8a8a✦ &fDüel Sandığı"));
        lore.add(color("&#4a4a5a▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        im.setLore(lore);
    ...
    private void warnElytraZone(Player p) {
        ...
        p.sendMessage(color("&#ff9ecbSilvera &#8a8a8a✦ &fArena Bölgesinde Elytra Kullanamazsın!"));

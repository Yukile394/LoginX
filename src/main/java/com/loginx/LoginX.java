...
public class LoginX extends JavaPlugin implements Listener {
    ...
    private ItemStack buildDailyRewardKey(String kasaId, int amount) {
        ...
        ItemStack item = new ItemStack(Material.OMINOUS_BOTTLE, Math.max(1, amount));
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(buildRgbFlop(kasaName, DAILY_REWARD_GRADIENT, false));
        List<String> lore = new ArrayList<>();
        lore.add(color("&#5a5a6a▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        lore.add(color("&fSunucumuzun günlük giriş ödül sisteminden"));
        lore.add(color("&fkazandığın, &#ff9ecbSilvera &fmühürlü özel bir anahtardır."));
        lore.add(color(""));
        lore.add(color("&7Anahtar Türü &8» &f" + kasaName));
        lore.add(color("&7Açtığı Kasa &8» &#ff9ecb" + kasaName));
        lore.add(color("&7Elindeki Adet &8» &f" + amount));
        lore.add(color(""));
        lore.add(color("&7Kullanmak için sunucudaki &#ff9ecb" + kasaName));
        lore.add(color("&7bloğuna sağ tıkla ve ödülünü hemen kap!"));
        lore.add(color(""));
        lore.add(color("&#5fb87a▸ &7Kaybolmaz, elden ele takas edilebilir."));
        lore.add(color("&#5a5a6a▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        meta.setLore(lore);
    ...
    private void openDailyRewardMenu(Player p) {
        ...
        String title = color("&fSilvera &#ff9ecb✦ Günlük Ödül ✦");
    ...
    public void onChat(org.bukkit.event.player.AsyncPlayerChatEvent ev) {
        ...
        if (hasKufur) {
            ...
            if (warnK >= 5) {
                ...
                p.sendMessage(silvera() + color(" ") + warnFlop("KÜFÜR Uyarısı") + color(" &85/5 &8— " + kufurMuteRengi + "10 dakika susturuldun!"));
                for (Player on : Bukkit.getOnlinePlayers())
                    if (on.hasPermission("loginx.admin"))

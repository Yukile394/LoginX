...
/**
 * Bir trapin tüm verilerini tutan model sınıfı.
 */
public class TrapData {
    ...
    private Location spawnLocation; // /trap tp veya alış sonrası TP noktası

    private final List<UUID> members = new ArrayList<>();

    public TrapData(int id, UUID owner, String ownerName, Location pos1, Location pos2, double salePrice) {
        this.id = id;
        this.owner = owner;
    ...
    /**
     * Verilen lokasyonun bu trapın içinde olup olmadığını kontrol eder.
     */
